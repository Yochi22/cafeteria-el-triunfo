<div class="container">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <img src="img/principal.jpg" alt="Logo" style="width:45px; margin-right:10px;">
        <label class="navbar-brand">Cafetería El Triunfo</label>
        <button class="navbar-toggler" type="button" data-toggle="collapse"
                data-target="#menuPrincipal" aria-controls="menuPrincipal"
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="menuRegistros" data-toggle="dropdown">
                        Registros
                    </a>
