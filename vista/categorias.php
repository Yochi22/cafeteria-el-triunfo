        ...
        <main class="main-content w-100 p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn btn-crear d-flex align-items-center gap-2" onclick="nuevo()">
                    <i class="bi bi-plus-circle fs-4"></i> Agregar Categoría
                </button>
            </div>

            <div id="contenedor_categorias" class="mt-4">
                <div class="row" id="cuadricula_categorias"></div>
            </div>
        </main>
    </div>
            ...
            <div class="modal-content border-0 rounded-4 shadow">
                ...
                <div class="modal-body pt-3">
                    <form id="f">
                        ...
                        <div class="mb-3">
                            <label for="nombre" class="form-label text-muted small">Nombre de la Categoría</label>
